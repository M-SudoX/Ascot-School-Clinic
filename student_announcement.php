...
// ✅ SAMPLE ANNOUNCEMENTS DATA (Remove when database is ready)
$announcements = [
    [
        'id' => 1,
        'title' => 'Clinic Closure',
        'content' => 'The clinic is temporarily closed for consultation from October 3 - 5, 2025 due to facility maintenance. Emergency consultations will be accommodated through online booking only.',
        'category' => 'important',
        'is_urgent' => true,
    ...
    [
        ...
        'content' => 'Please reschedule your consultation appointments during the closure period. You may book new appointments starting October 6, 2025.',
        'category' => 'reminder',
        'is_urgent' => false,
    ...
    [
        ...
        'content' => 'All students visiting the clinic must wear face masks and observe proper social distancing. Temperature checks will be conducted at the entrance.',
        'category' => 'health',
        'is_urgent' => false,
    ...
    [
        ...
        'content' => 'Starting next week, the clinic will be open from 8:00 AM to 6:00 PM on weekdays to better serve our students.',
        'category' => 'schedule',
        'is_urgent' => false,
...
/* 
===============================================
DATABASE VERSION (Use this when DB is ready):
===============================================
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                ...
                <div class="alert alert-info mb-3" role="alert">
                    ...
                    <strong>Demo Mode:</strong> Showing sample announcements. Connect to database for real data.
                </div>
                            ...
                            <div class="announcement-card">
                                ...
                                <?php if (!empty($announcement['category'])): ?>
                                    <div class="announcement-footer">
                                        <span class="announcement-category <?php echo htmlspecialchars($announcement['category']); ?>">
