...
// ===============================
// ✅ HANDLE ACTIONS FOR RESCHEDULED CONSULTATIONS
// ===============================
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action && $id) {
        try {
            if ($action === 'delete') {
                ...
                $stmt->execute([$id]);
                $_SESSION['success_message'] = "Rescheduled consultation approved successfully.";
            }
    ...
    header("Location: rescheduled_consultations.php");
    exit();
}

// ===============================
// ✅ FETCH ONLY RESCHEDULED CONSULTATION REQUESTS
// ===============================
$stmt = $pdo->prepare("
...
<head>
    ...
    <title>Rescheduled Consultations - ASCOT Clinic</title>
...
<body>
    ...
    <div class="dashboard-container">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-group">
                    ...
                    <div class="submenu show" id="appointmentsMenu">
                        ...
                        <a href="rescheduled_consultations.php" class="submenu-item active">
                            <i class="fas fa-calendar-alt"></i>
        ...
        <main class="main-content">
            ...
            <div class="page-header fade-in">
                <h1><i class="fas fa-calendar-alt me-2"></i>Rescheduled Consultations</h1>
                <p>View and manage rescheduled consultation requests</p>
            </div>
            ...
            <!-- Rescheduled Consultations Container -->
            <div class="dashboard-card fade-in">
                <div class="card-header">
                    <h3 class="card-title">Rescheduled Consultations</h3>
                    <div class="pending-badge" style="background: linear-gradient(135deg, #6c757d 0%, #5a6268 100%);">
                        <i class="fas fa-calendar-alt me-1"></i>
                        <?= count($consultations); ?> Rescheduled
                    </div>
                </div>
                            ...
                            <?php if (empty($consultations)): ?>
                                <tr>
                                    <td colspan="5" class="text-center py-4">
                                        ...
                                        <p class="text-muted">No rescheduled consultations found.</p>
                                    </td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($consultations as $c): ?>
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            <!-- APPROVE BUTTON FOR RESCHEDULED CONSULTATIONS -->
                                            <form method="POST" class="d-inline" onsubmit="return confirmApprove()">
                                                <input type="hidden" name="consultation_id" value="<?= $c['id']; ?>">
                                                <input type="hidden" name="action" value="approve">
                                                <button type="submit" class="btn-approve" title="Approve Rescheduled Date">
                                                    <i class="fas fa-check-circle"></i>
                                                </button>
                                            </form>
    ...
    <script>
        ...
        function confirmDelete() {
            return confirm('Are you sure you want to delete this rescheduled consultation? This action cannot be undone.');
        }

        // Approve confirmation function
        function confirmApprove() {
            return confirm('Are you sure you want to approve this rescheduled consultation?');
        }
    </script>
</body>
</html>