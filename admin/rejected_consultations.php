...
// ===============================
// ✅ HANDLE ACTIONS FOR REJECTED CONSULTATIONS
// ===============================
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: rejected_consultations.php");
    exit();
}

// ===============================
// ✅ FETCH ONLY REJECTED CONSULTATION REQUESTS
// ===============================
$stmt = $pdo->prepare("
...
<head>
    ...
    <title>Rejected Consultations - ASCOT Clinic</title>
    ...
    <div class="dashboard-container">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-group">
                    ...
                    <div class="submenu show" id="appointmentsMenu">
                        ...
                        <a href="rejected_consultations.php" class="submenu-item active">
        ...
        <main class="main-content">
            ...
            <div class="page-header fade-in">
                <h1><i class="fas fa-times-circle me-2"></i>Rejected Consultations</h1>
                <p>View rejected consultation requests</p>
            </div>
        ...
        View Rescheduled
            ...
            <!-- Rejected Consultations Container -->
            <div class="dashboard-card fade-in">
                <div class="card-header">
                    <h3 class="card-title">Rejected Consultations</h3>
                    <div class="pending-badge" style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%);">
                        <i class="fas fa-times-circle me-1"></i>
                        <?= count($consultations); ?> Rejected
                    </div>
                </div>
                            ...
                            <?php if (empty($consultations)): ?>
                                <tr>
                                    <td colspan="5" class="text-center py-4">
                                        ...
                                        <p class="text-muted">No rejected consultations found.</p>
                                    </td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($consultations as $c): ?>
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            <!-- DELETE BUTTON ONLY FOR REJECTED CONSULTATIONS -->
...
notificationItems.forEach(item => {
    ...
    item.style.cursor = 'pointer';
        ...
        function confirmDelete() {
            return confirm('Are you sure you want to delete this rejected consultation? This action cannot be undone.');
        }
    </script>
</body>
</html>